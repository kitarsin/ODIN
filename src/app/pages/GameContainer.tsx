  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-background text-foreground transition-colors">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-1 items-center justify-center px-6 py-6">
        <div
          className={`flex w-full h-full flex-col items-stretch gap-4 lg:flex-row ${
        ...
        >
          ...
          <div
            className={`flex min-h-0 min-w-0 h-full overflow-hidden transition-[flex-basis,opacity,transform] duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] lg:self-stretch lg:items-stretch ${
              terminalOpen
                ? 'opacity-100 lg:basis-[520px] lg:translate-x-0'
